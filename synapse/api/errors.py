...
class Codes(object):
    ...
    FIDO2_SECURITY_KEY_IN_USE = "M_FIDO2_SECURITY_KEY_IN_USE"
    FIDO2_FLOW_IN_PROCESS = "M_FIDO2_FLOW_IN_PROCESS"
    FIDO2_CHALLENGE_NOT_FOUND = "M_FIDO2_CHALLENGE_NOT_FOUND"
    FIDO2_DELETE_CHALLENGE = "M_FIDO2_DELETE_CHALLENGE"
